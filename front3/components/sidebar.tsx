      ...
      <div className="py-3 px-2.5 flex items-center  min-h-[60px]">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <div className={cn(
            ...
            <span className="font-semibold text-sidebar-foreground truncate whitespace-nowrap">Eduwill 챗봇</span>
          </div>
        </div>
      </div>
        ...
        <div className="flex-1 flex flex-col min-h-0">
          <ScrollArea className="flex-1 p-3">
            <div className="space-y-2">
              <div className="px-2 py-1">
                <h3 className="text-xs font-semibold text-sidebar-foreground/70 uppercase tracking-wider">채팅</h3>
              </div>
                  ...
                  <div className="flex items-center min-w-0 flex-1">
                    <div
                      className={cn(
                        ...
                        currentSessionId === session.id ? "bg-accent-foreground" : "bg-sidebar-foreground/30",
                      )}
                    />
                    <div className="min-w-0 flex-1">
                      <span className="block truncate text-sm font-medium leading-tight">{session.title}</span>
          ...
          <div className="p-4  bg-sidebar/50">
            <div className="text-center">
              <div className="text-xs text-sidebar-foreground/70 mb-1">Powered by</div>
              <div className="text-sm font-semibold text-sidebar-primary">Eduwill Chat v2.0</div>
            </div>
          </div>
        </div>
      )}
